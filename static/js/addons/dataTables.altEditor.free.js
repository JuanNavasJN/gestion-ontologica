    ...
    $.extend(
        altEditor.prototype,
        {
            ...
            _openEditModal: function () {
                ...
                var data = this.createDialog(columnDefs, 'Editar registro', 'Editar', 'Cerrar', 'editRowBtn');
            ...
            _openDeleteModal: function () {
                ...
                $(selector).on('show.bs.modal', function () {
                    var btns = '<button type="button" data-content="remove" class="btn btn-default" data-dismiss="modal">Cerrar</button>' +
                        '<button type="button"  data-content="remove" class="btn btn-danger" id="deleteRowBtn">Eliminar</button>';
                    $(selector).find('.modal-title').html('Eliminar Registro');
            ...
            _openAddModal: function () {
                var dt = this.s.dt;
                var columnDefs = this.completeColumnDefs();
                var data = this.createDialog(columnDefs, 'Agregar Registro', 'Agregar', 'Cerrar', 'addRowBtn');
